...
class Entry():
    def __init__(self, master, canvas, x, y, color):
        ...
        if self.os == 'M':  # Mac
            ...
            self.entry = tk.Entry(master=self.master, bg=Color.whitegray, bd=0, font=("Inter SemiBold", 9),
                                  fg=self.color, selectforeground=self.color, highlightthickness=0,
                                  insertbackground=self.color, insertwidth=2, justify="center", width=8,
