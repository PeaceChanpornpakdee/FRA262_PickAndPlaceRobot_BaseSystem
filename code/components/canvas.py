...
class Canvas():
    ...
    #     oval_1 = self.canvas.create_oval(x,       y,       x+2*r, y+2*r, fill=color, outline='')
    #     oval_2 = self.canvas.create_oval(x+w-2*r, y,       x+w,   y+2*r, fill=color, outline='')
    #     oval_3 = self.canvas.create_oval(x,       y+h-2*r, x+2*r, y+h,   fill=color, outline='')
    #     oval_4 = self.canvas.create_oval(x+w-2*r, y+h-2*r, x+w,   y+h,   fill=color, outline='')
    #     rec_1  = self.canvas.create_rectangle(x+r, y,   x+w-r, y+h,   fill=color, outline='')
    #     rec_2  = self.canvas.create_rectangle(x,   y+r, x+w,   y+h-r, fill=color, outline='')

    # def delete_round_rectangle(self):
    #     self.canvas.delete(self.oval_1)
    #     self.canvas.delete(self.oval_1)
    #     self.canvas.delete(self.oval_1)
